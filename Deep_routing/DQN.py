...
class DQN(nn.Module):
    ...
    num_states: the number of nodes in the network and also the number of outputs for the network.
    num_extra_params: the number of other parameters besides for the one-hot encoded vector for the current node we are taking in.
    ...
    def __init__(self, num_states, num_extra_params):
        ...
        self.layer3 = nn.Linear(hidden_size, num_states)
    ...
    def forward(self, x):
        ...
        out = self.tanh(self.layer2(out1))
